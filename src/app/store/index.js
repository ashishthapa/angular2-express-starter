...
var train_reducer_1 = require("./train/train.reducer");
var common_1 = require("@angular/common");
var paper_effects_1 = require("./paper/paper.effects");
var selectedpaper_reducer_1 = require("./paper/selectedpaper.reducer");
var train_effects_1 = require("./train/train.effects");
var traindisplay_reducer_1 = require("./traindisplay/traindisplay.reducer");
// all new reducers should be define here
var reducers = {
    paper: paper_reducer_1.paperReducer,
    selectedPaper: selectedpaper_reducer_1.selectedPaperReducer,
    train: train_reducer_1.trainReducer,
    trainDisplay: traindisplay_reducer_1.trainDisplayReducer
};
...
exports.effects = [
    ...
    effects_1.EffectsModule.run(train_effects_1.TrainEffects)
];
